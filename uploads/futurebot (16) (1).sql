...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2025 at 05:25 PM
...
INSERT INTO `companies` (`id`, `name`, `start_year`, `trade_license`, `email`, `password`, `address`, `document_path`, `status`, `created_at`, `is_approved`) VALUES
(1, 'Tariq', 2010, '1010010', 'tish@gmail.com', '$2y$10$EGpVCu.5HJKkGhoM2XPykuo6HpwfNbYMuQFgkOcviwPvWsn3FjLEa', 'Dhaka,Bangladesh', 'uploads/futurebot (14).sql', 'approved', '2025-08-02 11:25:48', 1),
(3, 'Tariq', 2010, '1010010', 'tisha@gmail.com', '$2y$10$Uw58JYZaOJG7u7..Z0ooVuAH96xS.WidP/xyA45J/4d/T7wM2TxE2', 'Dhaka,Bangladesh', 'uploads/ffffff.pdf', 'approved', '2025-08-02 12:42:27', 0),
(4, 'Tariq', 2010, '1010010', 'tishaa@gmail.com', '$2y$10$T7Lr5W5wm90q6XW9BMPpJ.HxOlLClOaeuxwfkfNqpMLKMow8nxeWy', 'Dhaka,Bangladesh', 'uploads/ffffff.pdf', 'approved', '2025-08-02 12:46:16', 0),
(5, 'Tariq', 2010, '1010010', 'tishaaa@gmail.com', '$2y$10$s8RIkGKoqe47SILccDUHlOW7oi.RWCeOgi8AQPu3s2jnqgUiPy1Qe', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/ffffff.pdf', 'approved', '2025-08-02 12:53:57', 0),
(6, 'Tariq', 2010, '1010010', 'irtezaa@gmail.com', '$2y$10$qEeIg2GEkoryhXVYxMGnUu2WyhyB4wprGL.sWwj26NbWjpqRR2qCW', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (12).sql', 'approved', '2025-08-02 12:59:53', 0),
(7, 'Tariq', 2010, '1010010', 'ir@gmail.com', '$2y$10$ZewqCMSFzK5pUhtHJ105rO/yIpugStGZz/FKEznxdoA/fts0er9Pm', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/ffffff.pdf', 'approved', '2025-08-02 13:02:57', 0),
(8, 'Tariq', 2010, '1010010', 'a@gmail.com', '$2y$10$Jn1uILBGGV2oM/tsMSt3n.I2DGtoIskr0WBejTJI/zKAzcmNY1hwq', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/PHPMailer-master (2).zip', 'approved', '2025-08-02 13:14:39', 0),
(9, 'Tariq', 2010, '1010010', 'ab@gmail.com', '$2y$10$w5DUo2ITaasyqUnX0uM5L.fXeaYAYkQwo9pJAQQVvWXFwtbd7hIBi', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/PHPMailer-master (2).zip', 'approved', '2025-08-02 13:26:30', 0),
(10, 'Tariq', 2010, '1010010', 'irc@gmail.com', '$2y$10$1U.nopPoMe5nk2OuOoSspOevpt2wUszf/.4Y8Az8VJqCkoxZz/bNm', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/PHPMailer-master (2).zip', 'approved', '2025-08-02 13:30:42', 0),
(11, 'Tariq', 2010, '1010010', 'irce@gmail.com', '$2y$10$Ay.ODWjmJgBL/8VZ86/la.GWfUn9gq6TvLrUeQy9yby5GQWijc8Fu', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/PHPMailer-master (2).zip', 'approved', '2025-08-02 13:31:00', 0),
(12, 'Tariq', 2010, '1010010', 'irceb@gmail.com', '$2y$10$ZWzCa0uJ.FPW119NUmUvbuadLPF4oVxa19SnSszC06BDinYtBRhNi', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (14) (1).zip', 'approved', '2025-08-02 13:43:56', 0),
(13, 'Tariq', 2010, '1010010', 'm@gmail.com', '$2y$10$oTDyEtJpzFqSnXsMr/6ywOtShqbkYMn/0meI/q2dqZxu5n2MHVFfe', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (14) (1).zip', 'approved', '2025-08-02 13:44:22', 0),
(14, 'Tariq', 2010, '1010010', 'mm@gmail.com', '$2y$10$OdsG8HsCln9qenUk8FvHqeAV0jzlIoz6YQlMrCsGKAq2o7YELHdkq', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (15).sql', 'approved', '2025-08-02 14:21:16', 0),
(15, 'Tariq', 2010, '1010010', 'mbm@gmail.com', '$2y$10$1scu6qE40bKVGVZfHVPRPehf6Wka0oBpY5WnKZ3bI8Hvznucsgkyy', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (14) (1).zip', 'approved', '2025-08-02 14:21:34', 0),
(16, 'Tariq', 2010, '1010010', 'mbbm@gmail.com', '$2y$10$7KXC79P0oA8z125yEcg2U.Onq1cdrL0k.z9wFhWO0ooOQtV8QmkJ6', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (14) (1).zip', 'approved', '2025-08-02 14:21:51', 0),
(17, 'Tariq', 2010, '1010010', 'mmm@gmail.com', '$2y$10$GW.vOdyOdzZbuj5MHgu4zuG0SFMY6eUksldFnWwyeWawAM9euEyKC', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (14) (1).zip', 'approved', '2025-08-02 14:45:50', 0),
(18, 'Tariq', 2010, '1010010', 'mmmb@gmail.com', '$2y$10$Agklr.e0etxtSGipxeTM3.NbpDerg5DKcGcapiFj9brgXVknhKdkW', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (15).sql', 'approved', '2025-08-02 14:49:26', 0),
(19, 'Tariq', 2010, '1010010', 'ms@gmail.com', '$2y$10$zQZOABOBH/qulOxUziJ.3eyDyiGqlWwUgx/zz04bimR5B8FGRmHyi', 'Lake City Concord,Khilkhet,Dhaka', 'uploads/futurebot (14) (1).zip', 'approved', '2025-08-02 14:52:06', 0);
