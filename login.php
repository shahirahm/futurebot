...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($selected_role === 'company') {
            ...
            if ($stmt->num_rows === 1) {
                $stmt->bind_result($company_id, $company_name, $password_hash);
                $stmt->fetch();
                ...
                $error = "No company found with that email.";
            }
            $stmt->close();
        } else {
            // Original user login code for student/mentor/admin
...
<div class="main-content">
  ...
  <div class="login-container">
    ...
    <div class="link">
      ...
      <small>Companies: <a href="company_register.php">Register your company</a></small>
    </div>
  </div>
