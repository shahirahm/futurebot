...
// Simulate bkash payment process here
// For demo, we just show instructions and a 'Confirm Payment' button

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Here you would verify payment with bkash API
    // For now, just redirect to success
    header("Location: payment_success.php?book_id=$book_id&method=bkash");
    exit;
}
...
<body>
    ...
    <form method="POST">
        <label for="trx_id">Transaction ID: CH377T85FX</label><br />
